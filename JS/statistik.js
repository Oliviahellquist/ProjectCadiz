...
function showMore (event) {
    ...
    `;
    // Kollar ifall "showmoreBtn" innerHTML är lika med "Visa mer",
    //ifall detta är sant så skapar den strukturen med designen nedan.
    ...
    //annars tar den bort denna struktur ifall den finns
    else 
    {
...
//En funktion som fyller innehllet med data ifrån databasen
